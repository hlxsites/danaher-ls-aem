...
const social = `
                    <div class="flex items-center gap-4 back-btn">
                      <a href="javascript:history.back()" title="Back" class="rounded-lg flex gap-4 transition leading-6 py-1 px-1.5 hover:bg-slate-900/[0.03]">
                    ...
                    <div class="flex items-center gap-3 social-links">
                      <a href="javascript:window.print();" title="Print article" class="rounded-lg transition leading-6 py-1 px-1.5 hover:bg-slate-900/[0.03]">
                        <span class="icon icon-print"></span>
                      </a>
                      <a href="javascript:window.open('//twitter.com/intent/tweet?' + location.href + '&title=' + encodeURI(document.title) )" title="Share on X" class="rounded-lg transition leading-6 py-1 px-1.5 hover:bg-slate-900/[0.03]">
                        <span class="icon icon-twitter"></span>
                      </a>
                      <a href="javascript:window.open('//www.linkedin.com/shareArticle?mini=true&url=' + location.href + '&title=' + document.title )" title="Share on LinkedIn" class="rounded-lg transition leading-6 py-1 px-1.5 hover:bg-slate-900/[0.03]">
