...
export default function renderGridCard(item) {
  const card = div({
    class:
      'transform cursor-pointer transition duration-500 hover:shadow-md w-[331px] md:w-[305px] min-h-[485px] bg-white border border-1 border-gray-300 flex flex-col justify-start items-start',
  });
