...
export default function renderGridCard(item) {
  ...
  if (item.showCart && item.price !== undefined) {
    pricingAndActions = div(
      ...
      div(
        {
          class: 'px-4 py-3 inline-flex flex-col justify-start items-end gap-6',
        },
        div(
          {
      ...
      div(
        {
          class: 'px-4 py-3 inline-flex justify-start items-center gap-3',
        },
        input({
          type: 'number',
          value: '1',
    ...
    a(
      {
        href: item.url,
        class:
          'text-danaherpurple-500 hover:text-danaherpurple-800 flex items-center text-base font-bold leading-snug [&_svg>use]:hover:stroke-danaherpurple-800',
      },
      'View Details',
      span({
        class:
