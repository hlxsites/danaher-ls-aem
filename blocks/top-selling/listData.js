    ...
    div(
      ...
      div(
        ...
        div(
          ...
          img({
            class:
              "w-24 h-24 left-0 top-0 absolute rounded-md border border-gray-200 object-cover", // Fixed object-fit to object-cover
            src: imageUrl,
            alt: item.title || "",
          })
        )
    ...
    try {
      ...
      return {
        ...
        raw: {
          ...
          price: shopData.salePrice?.value, // Used by renderListCard
          availability: shopData.availability?.inStockQuantity || 0, // Used by renderListCard
        },
