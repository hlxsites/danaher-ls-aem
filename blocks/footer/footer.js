import { loadScript, readBlockConfig, decorateIcons } from '../../scripts/lib-franklin.js';
...
function generateStickyFooter(stickyFooter) {
  ...
  allNestedAnchorChilds.forEach((child) => {
    ...
    url.searchParams.set('utm_previouspage', window.location.href);
  ...
  // Accessibe - start
  accessibe.addEventListener('click', loadScript('../../scripts/lib-accessibe.js'));
  // Accessibe - end
