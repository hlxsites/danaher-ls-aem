export default function decorate(block) {
  block.classList.add(...'form-padding pt-12 sm:pt-16 stats-mainContentDiv-visibility'.split(' '));
  const mainContentDiv = block.firstElementChild;
  mainContentDiv?.classList.add(...'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'.split(' '));
  const innerContentDiv = mainContentDiv?.firstElementChild;
