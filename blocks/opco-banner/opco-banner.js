  ...
  const controls = div(
    {
      ...
      class: "flex absolute bottom-[38px] items-center justify-center gap-4",
    },
    button(
      {
        class:
    ...
    const slide = div(
      {
        ...
        }carousel-slide p-10 h-[600px] flex md:mb-6 dhlsBp:mb-0 flex-col items-center w-full relative`,
