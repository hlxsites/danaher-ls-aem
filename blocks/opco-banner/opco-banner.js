...
export default function decorate(block) {
  ...
  const leftContent = div({
    class: "flex flex-col gap-4 max-w-[567px] md:mr-7",
  });
  ...
  const left = div(
    {
      class: "flex flex-col gap-6 md:w-1/2 p-6 dhlsBp:pl-0 items-end bg-white",
    },
    leftContent
  );
  ...
  const controls = div(
    {
      ...
      class:
        "flex absolute bottom-6 dhlsBp:bottom-12 items-center dhlsxlBp:mr-[calc(50vw-71%)]  justify-center gap-4",
    },
    button(
      {
        class:
