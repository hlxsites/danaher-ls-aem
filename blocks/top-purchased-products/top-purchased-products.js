...
export default async function decorate(block) {
  ...
  const track = div({
    ...
    class: 'flex gap-5 duration-1000 ease-in-out transition-transform transform overflow-hidden scroll-smooth',

  });

  const carouselCards = div({ class: 'carousel-cards flex flex-wrap justify-start gap-5 w-full' }, track);
