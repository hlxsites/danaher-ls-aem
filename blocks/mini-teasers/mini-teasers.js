...
export default function decorate(block) {
  ...
  [...block.children].forEach((element) => {
    ...
    if (link) {
      ...
      link.innerHTML += ` <svg xmlns="http://www.w3.org/2000/svg" style="display:inline !important" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="w-4 h-4 ml-0.5" data-di-res-id="e64c7d67-741d6760" data-di-rand="1701088803659">
            <path fill-rule="evenodd" d="M2 10a.75.75 0 01.75-.75h12.59l-2.1-1.95a.75.75 0 111.02-1.1l3.5 3.25a.75.75 0 010 1.1l-3.5 3.25a.75.75 0 11-1.02-1.1l2.1-1.95H2.75A.75.75 0 012 10z" clip-rule="evenodd"></path>
            </svg>`;
      link.classList.add(...'text-sm font-medium text-danaherpurple-500'.split(' '));
      if (link.href.endsWith('#RequestAQuote')) link.classList.add(...'show-modal-btn'.split(' '));
    }
  });
