...
import productBannerDecorate from '../product-banner/product-banner.js';
import decorateTopSelling from '../top-selling/top-selling.js';

export default function decorate(block) {
  block.innerHTML = '';
  block.append(productBannerDecorate(block));
