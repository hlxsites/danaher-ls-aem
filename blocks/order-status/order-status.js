import {
  div, h6, p, h2, a, img, h4, h1, button, br, span
  ...
  const mainDiv = div(
    ...
    div(
      ...
      div(
        ...
        h2({ class: 'text-[18px] font-normal text-gray-800 mb-2' }, 'Order number: DHR134578-8978'),
        p({ class: 'text-[14px] text-gray-600' }, 'Congratulations! Your order is submitted. Get ready for the excitement as we process your purchase.')
      ),
      ...
      div(
        ...
        div(
          ...
          div(
            ...
            p({ class: 'text-[13px] text-gray-600 mt-2' }, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vel dolor, ultricies velit.')
          )
        ),
    ...
    div(
      ...
      div(
        ...
        div(
          ...
          h6({}, 'Stay informed about your recent orders by tracking them online.')
        )
      ),
