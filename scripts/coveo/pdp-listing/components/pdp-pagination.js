...
const renderPagination = () => {
  ...
  prevButton.innerHTML = `
    ...
    <span class="mr-2 font-semibold text-purple-700">Previous</span>
  `;
  prevButton.className = hasPreviousPage
    ? 'px-3 py-2 rounded-lg font-semibold border bg-white text-gray-600 hover:bg-gray-100 flex gap-1'
    : 'py-2 rounded-lg font-semibold opacity-60 cursor-not-allowed flex gap-1 items-center ';
  ...
  currentPages.forEach((page) => {
    ...
    pageButton.className = isActive
      ? 'w-10 h-10 rounded-lg font-semibold border bg-purple-700 text-white'
      : 'w-10 h-10 rounded-lg font-semibold border bg-white text-gray-700 hover:bg-purple-50';
  ...
  nextButton.innerHTML = `
    <span class="mr-2 font-semibold text-purple-700">Next</span>
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  nextButton.className = hasNextPage
    ? 'py-2 rounded-lg font-semibold bg-white text-gray-600 hover:bg-gray-100 flex gap-1 item-center'
    : 'px-3 py-2 rounded-lg font-semibold border opacity-60 cursor-not-allowed';
  ...
  pagerDiv.appendChild(leftContainer);
  pagerDiv.appendChild(centerContainer);
  pagerDiv.appendChild(rightContainer);
