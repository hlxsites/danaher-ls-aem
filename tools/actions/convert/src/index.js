...
/*
 ...
 //This condition check will removed
  if(!converterCfg.internalHost.includes('danaher-ls-aem-prod')) {
    ...
    if((path.includes('us/en/products.html') || path.includes('us/en/products/brands') || path.includes('us/en/products/antibodies') || path.includes('us/en/products/assay-kits') || path.includes('us/en/products/2d-3d-cell-culture-systems')) && !path.includes('/topics-jck1/')) {    
        return true;
    }
